...
2. Select your property: `zoeholidays.com`
...
```bash
curl -I https://zoeholidays.com/sitemap.xml
```
...
- https://zoeholidays.com/sitemap.xml - Should show XML content
- https://zoeholidays.com/robots.txt - Should only reference `/sitemap.xml`
