...
export const metadata: Metadata = {
  ...
  description: "Explore tourism investment opportunities in Egypt with zoeholidays. Partner with us for sustainable tourism development and profitable ventures.",
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://zoeholidays.com'}/tourism-investment`,
  },
  openGraph: {
    ...
    type: "website",
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://zoeholidays.com'}/tourism-investment`,
    images: [
      {
