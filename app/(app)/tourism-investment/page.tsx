...
import { TrendingUp, Building2, Users2, Globe2, DollarSign, FileBarChart } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  keywords: ["tourism investment Egypt", "hospitality investment", "travel industry partnerships", "Egypt tourism opportunities"],
};
  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <section>
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline">Download Investment Guide</Button>
            </div>
