// Service Worker for ZoeHolidays PWA
const CACHE_NAME = 'zoeholidays-v1';
      ...
      return fetch(event.request)
        .then((response) => {
          ...
          const shouldCache =
            ...
            url.pathname.startsWith('/placesTogo');
...
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'ZoeHolidays';
  const options = {
